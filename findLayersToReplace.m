...
% Get source, destination, and layer names (as string arrays).
...
% Nel caso di GoogLeNet, isClassificationLayer è un logical array 144x1 con
...
% Il classification layer così trovato
